...
const Formulaire = () => {
  ...
  useEffect(() => {
    const calcProgression = () => {
      ...
      // Mise à jour de la progression selon l'étape
      if (etape === 1) progress = 20;
      else if (etape === 2) progress = 40;
      else if (etape === 3) progress = 60; // Étape 3
      else if (etape === 3.1) progress = 80; // Étape 3.1
      else if (etape === 4) progress = 100;
  
      // Si nous sommes dans l'étape 3, on ajuste la progression selon la sous-étape
      if (etape === 3) {
        progress = etape3Sub === 1 ? 60 : 70; // Sous-étape 1 à 3: 60%, sous-étape 2 à 70%
      }
  
      setProgression(progress);
    };
  
    calcProgression(); // Calculer la progression à chaque changement d'étape
  }, [etape, etape3Sub]); // dépendance sur `etape` et `etape3Sub`
...
return (
  <>
    <div className="modal">
      ...
      {/* Contenu principal de la modal qui est défilable */}
      <div className="contenu-modal">
        <div className="formulaire-devisS">
          ...
          {/* Étape 3.1 */}
          {etape === 3.1 && (
            <div className="finalisation-container">
              <h1>Finalisation</h1>
              <div className="finalisation-options">
                <p>
                  Votre demande de devis est presque terminée ! Nous avons besoin de quelques informations supplémentaires
      ...
      {/* Footer de la modal */}
      <footer className="footerFormulaire">
