...
//     const [isMobile, setIsMobile] = useState(false); // Gérer le format mobile

//     useEffect(() => {
//         const handleResize = () => {
//             setIsMobile(window.innerWidth <= 768); // Basculer en mode mobile pour une largeur <= 768px
//         };

//         window.addEventListener('resize', handleResize);
//         handleResize(); // Vérifier une première fois lors du chargement
...
//             {/* Toggle pour mobile */}
//             {isMobile && (
//                 <Button variant="contained" color="primary" onClick={() => setIsModalOpen(!isModalOpen)}>
//                     {isModalOpen ? 'Fermer le formulaire' : 'Ouvrir le formulaire'}
//                 </Button>
//             )}
...
function Contact() {
    ...
    return (
        <div className="contact-container">
            ...
            {/* Boutons pour mobile ou desktop */}
            {isMobile ? (
