    ...
    const handleDevisClick = () => {
        switch (services[selectedService]) {
            case 'Les sites vitrines':
                navigate('/formulaire-devis-site-vitrine');
                break;
            case 'Les sites e-commerce':
                navigate('/formulaire-devis-ecommerce');
                break;
            case 'Les sites personnalisés':
                navigate('/formulaire-devis-personnalise');
                break;
            case 'Le référencement et SEO':
                navigate('/formulaire-devis-seo');
                break;
            case "L'hébergement sécurisé":
                navigate('/formulaire-devis-hebergement');
                break;
            case 'Gestion et maintenance':
                navigate('/formulaire-devis-maintenance');
                break;
            default:
